namespace Elmah
{
    ...
    public class SpeedBar
    {
        ...
        public static readonly ItemTemplate RssDigestFeed = new ItemTemplate("RSS Digest", "RSS feed of errors within recent days", "{0}/rss/digest");
        public static readonly FormattedItem Help = new FormattedItem("Help", "Documentation, discussions, issues and more", "https://github.com/wallymathieu/ElasticElmah");
